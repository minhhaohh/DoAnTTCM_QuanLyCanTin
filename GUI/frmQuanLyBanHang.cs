...
namespace GUI
{
    public partial class frmQuanLyBanHang : Form
    {
        ...
        private void btnDoAnSang_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn sáng").Rows.Count; i++)
            {
                listIdSP.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn sáng").Rows[i][0]);
                listTenSP.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn sáng").Rows[i][1]);
                listGia.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn sáng").Rows[i][2]);
                listSLConLai.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn sáng").Rows[i][3]);
                listHinhAnh.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn sáng").Rows[i][6]);
            }
        ...
        private void btnDoAnVat_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn vặt").Rows.Count; i++)
            {
                listIdSP.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn vặt").Rows[i][0]);
                listTenSP.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn vặt").Rows[i][1]);
                listGia.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn vặt").Rows[i][2]);
                listSLConLai.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn vặt").Rows[i][3]);
                listHinhAnh.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ ăn vặt").Rows[i][6]);
            }
        ...
        private void btnDoUong_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < SanPhamBUS.Instance.getSanPhamByLoai("Đồ uống").Rows.Count; i++)
            {
                listIdSP.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ uống").Rows[i][0]);
                listTenSP.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ uống").Rows[i][1]);
                listGia.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ uống").Rows[i][2]);
                listSLConLai.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ uống").Rows[i][3]);
                listHinhAnh.Add(SanPhamBUS.Instance.getSanPhamByLoai("Đồ uống").Rows[i][6]);
            }
        ...
        private void btnKhac_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < SanPhamBUS.Instance.getSanPhamByLoai("Khác").Rows.Count; i++)
            {
                listIdSP.Add(SanPhamBUS.Instance.getSanPhamByLoai("Khác").Rows[i][0]);
                listTenSP.Add(SanPhamBUS.Instance.getSanPhamByLoai("Khác").Rows[i][1]);
                listGia.Add(SanPhamBUS.Instance.getSanPhamByLoai("Khác").Rows[i][2]);
                listSLConLai.Add(SanPhamBUS.Instance.getSanPhamByLoai("Khác").Rows[i][3]);
                listHinhAnh.Add(SanPhamBUS.Instance.getSanPhamByLoai("Khác").Rows[i][6]);
            }
        ...
        {
            if (!this.dgvCTHD.Rows[this.rowIndex].IsNewRow)
            {
                this.dgvCTHD.Rows.RemoveAt(this.rowIndex);
            }
        }

        private void dgvCTHD_CellMouseUp(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                this.dgvCTHD.Rows[e.RowIndex].Selected = true;
                this.rowIndex = e.RowIndex;
                this.dgvCTHD.CurrentCell = this.dgvCTHD.Rows[e.RowIndex].Cells[1];
                this.contextMenuStrip1.Show(this.dgvCTHD, e.Location);
